...
part of 'merchant_order_api_service.dart';
...
class _MerchantOrderApiService implements MerchantOrderApiService {
  _MerchantOrderApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<HttpResponse<dynamic>> acceptOrder(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> processOrder(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> completeOrder(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<HttpResponse<dynamic>> acceptCancelOrder(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(
          ...
          .compose(
            _dio.options,
            '/api/seller/orders/${id}/cancel-request/accept',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<HttpResponse<dynamic>> rejectCancelOrder(
    ...
    final _options = _setStreamType<HttpResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/seller/orders/${id}/cancel-request/reject',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
