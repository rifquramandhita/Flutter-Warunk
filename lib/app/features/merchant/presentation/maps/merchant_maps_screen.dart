...
class MerchantMapsScreen extends StatelessWidget {
  ...
  MerchantMapsScreen({super.key, this.initialLatitude, this.initialLongitude});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MerchantMapsBloc>()
        ..add(
          MerchantMapsEventInit(
            initialLatitude: initialLatitude,
            initialLongitude: initialLongitude,
          ),
        ),
      child: BlocConsumer<MerchantMapsBloc, MerchantMapsState>(
  ...
  Widget _mapLayout(BuildContext context) {
    final state = context.read<MerchantMapsBloc>().state;
      ...
      onCameraIdle: () async {
        ...
        if (context.mounted) {
          context.read<MerchantMapsBloc>().add(
            MerchantMapsEventLocationChanged(centerLat, centerLng),
          );
        }
      },
    );
  ...
  Widget _myLocationButtonLayout(BuildContext context) {
    ...
    return Positioned(
      ...
      child: FloatingActionButton(
        ...
        onPressed: () {
          context.read<MerchantMapsBloc>().add(
            MerchantMapsEventGetMyLocation(),
          );
        },
