...
mixin _$MerchantProductVariant {
 ...
 String get id; String get productId; Map<String, dynamic> get variantCombination; String? get sku; int get price; int get stock; int get minPurchase; int? get weight; int? get length; int? get width; int? get height; DateTime? get createdAt; DateTime? get updatedAt;
...
@override
String toString() {
  return 'MerchantProductVariant(id: $id, productId: $productId, variantCombination: $variantCombination, sku: $sku, price: $price, stock: $stock, minPurchase: $minPurchase, weight: $weight, length: $length, width: $width, height: $height, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( MerchantProductVariantEntity value)?  entity,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( MerchantProductVariantEntity value)  entity,}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( MerchantProductVariantEntity value)?  entity,}){
final _that = this;
switch (_that) {
case MerchantProductVariantEntity() when entity != null:
return entity(_that);case _:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String id,  String productId,  Map<String, dynamic> variantCombination,  String? sku,  int price,  int stock,  int minPurchase,  int? weight,  int? length,  int? width,  int? height,  DateTime? createdAt,  DateTime? updatedAt)  entity,}) {final _that = this;
switch (_that) {
case MerchantProductVariantEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String id,  String productId,  Map<String, dynamic> variantCombination,  String? sku,  int price,  int stock,  int minPurchase,  int? weight,  int? length,  int? width,  int? height,  DateTime? createdAt,  DateTime? updatedAt)?  entity,}) {final _that = this;
switch (_that) {
case MerchantProductVariantEntity() when entity != null:
return entity(_that.id,_that.productId,_that.variantCombination,_that.sku,_that.price,_that.stock,_that.minPurchase,_that.weight,_that.length,_that.width,_that.height,_that.createdAt,_that.updatedAt);case _:
  return null;
