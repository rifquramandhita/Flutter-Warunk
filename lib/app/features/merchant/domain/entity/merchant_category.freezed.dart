...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MerchantCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.slug, slug) || other.slug == slug));
}
...
@override
String toString() {
  return 'MerchantCategory(id: $id, name: $name, slug: $slug)';
}
...
class MerchantCategoryEntity implements MerchantCategory {
  const MerchantCategoryEntity({required this.id, required this.name, required this.slug});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MerchantCategoryEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.slug, slug) || other.slug == slug));
}
...
@override
String toString() {
  return 'MerchantCategory.entity(id: $id, name: $name, slug: $slug)';
}
