...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,slug,merchantId,category,branch,description,stock,minPurchase,price,isPublished,hasVariant,isSameDimension,sku,weight,length,width,height,const DeepCollectionEquality().hash(merchant),const DeepCollectionEquality().hash(productCategory),const DeepCollectionEquality().hash(variants),const DeepCollectionEquality().hash(images),rating,reviewsCount,const DeepCollectionEquality().hash(reviews),isWishlisted,createdAt,updatedAt,chatUrl]);

@override
String toString() {
  return 'CustomerProduct(id: $id, name: $name, slug: $slug, merchantId: $merchantId, category: $category, branch: $branch, description: $description, stock: $stock, minPurchase: $minPurchase, price: $price, isPublished: $isPublished, hasVariant: $hasVariant, isSameDimension: $isSameDimension, sku: $sku, weight: $weight, length: $length, width: $width, height: $height, merchant: $merchant, productCategory: $productCategory, variants: $variants, images: $images, rating: $rating, reviewsCount: $reviewsCount, reviews: $reviews, isWishlisted: $isWishlisted, createdAt: $createdAt, updatedAt: $updatedAt, chatUrl: $chatUrl)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,slug,merchantId,category,branch,description,stock,minPurchase,price,isPublished,hasVariant,isSameDimension,sku,weight,length,width,height,const DeepCollectionEquality().hash(merchant),const DeepCollectionEquality().hash(productCategory),const DeepCollectionEquality().hash(_variants),const DeepCollectionEquality().hash(_images),rating,reviewsCount,const DeepCollectionEquality().hash(_reviews),isWishlisted,createdAt,updatedAt,chatUrl]);
