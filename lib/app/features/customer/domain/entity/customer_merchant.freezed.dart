...
/// Create a copy of CustomerMerchant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? slug = null,Object? photo = freezed,Object? isActive = null,Object? isOpen = null,Object? userId = freezed,Object? merchantCategory = freezed,Object? status = freezed,Object? statusChangedBy = freezed,Object? whatsappNumber = freezed,Object? isOpenAllDay = freezed,Object? isOpen24Hours = freezed,Object? timeOpen = freezed,Object? timeClose = freezed,Object? internalCourier = freezed,Object? instantCourier = freezed,Object? pickupAtStore = freezed,Object? courierCodeAvailable = freezed,Object? maxDistanceInternalCourier = freezed,Object? merchantAccounts = freezed,Object? merchantOpens = freezed,Object? address = freezed,Object? province = freezed,Object? city = freezed,Object? district = freezed,Object? postalCode = freezed,Object? longitude = freezed,Object? latitude = freezed,Object? balance = freezed,Object? currentBalance = freezed,Object? distance = freezed,Object? rating = freezed,Object? reviewsCount = freezed,Object? promoBadges = freezed,Object? user = freezed,Object? chatUrl = freezed,Object? about = freezed,Object? internalCourierShippingCost = freezed,Object? aboutSections = freezed,Object? reviewSummary = freezed,Object? reviewBreakdown = freezed,Object? reviews = freezed,Object? reviewEmptyMessage = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
switch (_that) {
case CustomerMerchantEntity():
return entity(_that.id,_that.name,_that.slug,_that.photo,_that.isActive,_that.isOpen,_that.userId,_that.merchantCategory,_that.status,_that.statusChangedBy,_that.whatsappNumber,_that.isOpenAllDay,_that.isOpen24Hours,_that.timeOpen,_that.timeClose,_that.internalCourier,_that.instantCourier,_that.pickupAtStore,_that.courierCodeAvailable,_that.maxDistanceInternalCourier,_that.merchantAccounts,_that.merchantOpens,_that.address,_that.province,_that.city,_that.district,_that.postalCode,_that.longitude,_that.latitude,_that.balance,_that.currentBalance,_that.distance,_that.rating,_that.reviewsCount,_that.promoBadges,_that.user,_that.chatUrl,_that.about,_that.internalCourierShippingCost,_that.aboutSections,_that.reviewSummary,_that.reviewBreakdown,_that.reviews,_that.reviewEmptyMessage,_that.createdAt,_that.updatedAt);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,slug,photo,isActive,isOpen,userId,merchantCategory,status,statusChangedBy,whatsappNumber,isOpenAllDay,isOpen24Hours,timeOpen,timeClose,internalCourier,instantCourier,pickupAtStore,const DeepCollectionEquality().hash(_courierCodeAvailable),maxDistanceInternalCourier,const DeepCollectionEquality().hash(_merchantAccounts),const DeepCollectionEquality().hash(_merchantOpens),address,province,city,district,postalCode,longitude,latitude,balance,currentBalance,distance,rating,reviewsCount,const DeepCollectionEquality().hash(_promoBadges),const DeepCollectionEquality().hash(user),chatUrl,about,internalCourierShippingCost,const DeepCollectionEquality().hash(_aboutSections),const DeepCollectionEquality().hash(reviewSummary),const DeepCollectionEquality().hash(_reviewBreakdown),const DeepCollectionEquality().hash(_reviews),reviewEmptyMessage,createdAt,updatedAt]);
