...
/// Create a copy of CustomerMerchant
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? slug = null,Object? photo = freezed,Object? isActive = null,Object? isOpen = null,Object? userId = freezed,Object? merchantCategory = freezed,Object? status = freezed,Object? statusChangedBy = freezed,Object? whatsappNumber = freezed,Object? isOpenAllDay = freezed,Object? isOpen24Hours = freezed,Object? timeOpen = freezed,Object? timeClose = freezed,Object? internalCourier = freezed,Object? instantCourier = freezed,Object? pickupAtStore = freezed,Object? courierCodeAvailable = freezed,Object? maxDistanceInternalCourier = freezed,Object? merchantAccounts = freezed,Object? merchantOpens = freezed,Object? address = freezed,Object? province = freezed,Object? city = freezed,Object? district = freezed,Object? postalCode = freezed,Object? longitude = freezed,Object? latitude = freezed,Object? isVerified = freezed,Object? balance = freezed,Object? currentBalance = freezed,Object? distance = freezed,Object? rating = freezed,Object? reviewsCount = freezed,Object? promoBadges = freezed,Object? user = freezed,Object? chatUrl = freezed,Object? about = freezed,Object? internalCourierShippingCost = freezed,Object? aboutSections = freezed,Object? reviewSummary = freezed,Object? reviewBreakdown = freezed,Object? reviews = freezed,Object? reviewEmptyMessage = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as int?,promoBadges: freezed == promoBadges ? _self.promoBadges : promoBadges // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case CustomerMerchantEntity():
return entity(_that.id,_that.name,_that.slug,_that.photo,_that.isActive,_that.isOpen,_that.userId,_that.merchantCategory,_that.status,_that.statusChangedBy,_that.whatsappNumber,_that.isOpenAllDay,_that.isOpen24Hours,_that.timeOpen,_that.timeClose,_that.internalCourier,_that.instantCourier,_that.pickupAtStore,_that.courierCodeAvailable,_that.maxDistanceInternalCourier,_that.merchantAccounts,_that.merchantOpens,_that.address,_that.province,_that.city,_that.district,_that.postalCode,_that.longitude,_that.latitude,_that.isVerified,_that.balance,_that.currentBalance,_that.distance,_that.rating,_that.reviewsCount,_that.promoBadges,_that.user,_that.chatUrl,_that.about,_that.internalCourierShippingCost,_that.aboutSections,_that.reviewSummary,_that.reviewBreakdown,_that.reviews,_that.reviewEmptyMessage,_that.createdAt,_that.updatedAt);}
}
...
@override final  int? reviewsCount;
 final  List<String>? _promoBadges;
@override List<String>? get promoBadges {
  final value = _promoBadges;
  if (value == null) return null;
  if (_promoBadges is EqualUnmodifiableListView) return _promoBadges;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
as double?,rating: freezed == rating ? _self.rating : rating // ignore: cast_nullable_to_non_nullable
as double?,reviewsCount: freezed == reviewsCount ? _self.reviewsCount : reviewsCount // ignore: cast_nullable_to_non_nullable
as int?,promoBadges: freezed == promoBadges ? _self._promoBadges : promoBadges // ignore: cast_nullable_to_non_nullable
as List<String>?,user: freezed == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as CustomerMerchantUserEntity?,chatUrl: freezed == chatUrl ? _self.chatUrl : chatUrl // ignore: cast_nullable_to_non_nullable
as String?,about: freezed == about ? _self.about : about // ignore: cast_nullable_to_non_nullable
as String?,internalCourierShippingCost: freezed == internalCourierShippingCost ? _self.internalCourierShippingCost : internalCourierShippingCost // ignore: cast_nullable_to_non_nullable
