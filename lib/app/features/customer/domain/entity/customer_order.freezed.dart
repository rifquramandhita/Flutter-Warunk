...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String addressId,  String? shippingKey,  String? biteshipRateKey,  String? merchantAccountId,  String? notes,  List<String> cartIds,  String? promotionId,  String? promotionCode)  createParam,required TResult Function( List<String> cartIds,  String? addressId,  String? shippingKey,  String? biteshipRateKey)  getPromotionParam,required TResult Function( String orderId,  List<CustomerOrderCompleteReviewParam> reviews)  completeParam,required TResult Function( String orderItemId,  int rating,  String? review, @JsonKey(includeFromJson: false, includeToJson: false)  List<File> images)  completeReviewParam,required TResult Function( String orderId,  String reason,  String? customerBank,  String? customerAccountNumber,  String? customerAccountName)  cancelParam,required TResult Function( String? id,  String? invoiceNumber,  String? invoiceUrl,  String? merchantId,  int? customerId,  String? customerAddressId,  String? merchantAccountId,  int? subtotal,  int? shippingCost,  int? serviceFee,  String? promotionId,  String? promotionCode,  String? promotionTitle,  String? promotionType,  int? promotionDiscount,  dynamic promotion,  List<dynamic>? promotions,  int? total,  int? paidAmount,  String? paymentProof,  String? type,  OrderStatus? status,  String? statusLabel,  String? notes,  String? cancelReason,  String? customerBank,  String? customerAccountNumber,  String? customerAccountName,  String? refundProof,  dynamic customer,  dynamic customerAddress,  dynamic merchantAccount,  dynamic merchant,  List<CustomerOrderItemEntity>? items,  List<dynamic>? reviews,  bool? needsReview,  CustomerShippingEntity? shipping,  String? paidAt,  String? cancelledAt,  String? completedAt,  String? createdAt,  String? updatedAt,  String? chatUrl, @JsonKey(name: 'next_actions')  List<CustomerOrderNextActionEntity>? nextActions)  entity,}) {final _that = this;
switch (_that) {
case CustomerOrderCreateParam():
return createParam(_that.addressId,_that.shippingKey,_that.biteshipRateKey,_that.merchantAccountId,_that.notes,_that.cartIds,_that.promotionId,_that.promotionCode);case CustomerOrderGetPromotionParam():
...
return entity(_that.id,_that.invoiceNumber,_that.invoiceUrl,_that.merchantId,_that.customerId,_that.customerAddressId,_that.merchantAccountId,_that.subtotal,_that.shippingCost,_that.serviceFee,_that.promotionId,_that.promotionCode,_that.promotionTitle,_that.promotionType,_that.promotionDiscount,_that.promotion,_that.promotions,_that.total,_that.paidAmount,_that.paymentProof,_that.type,_that.status,_that.statusLabel,_that.notes,_that.cancelReason,_that.customerBank,_that.customerAccountNumber,_that.customerAccountName,_that.refundProof,_that.customer,_that.customerAddress,_that.merchantAccount,_that.merchant,_that.items,_that.reviews,_that.needsReview,_that.shipping,_that.paidAt,_that.cancelledAt,_that.completedAt,_that.createdAt,_that.updatedAt,_that.chatUrl,_that.nextActions);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String addressId,  String? shippingKey,  String? biteshipRateKey,  String? merchantAccountId,  String? notes,  List<String> cartIds,  String? promotionId,  String? promotionCode)?  createParam,TResult? Function( List<String> cartIds,  String? addressId,  String? shippingKey,  String? biteshipRateKey)?  getPromotionParam,TResult? Function( String orderId,  List<CustomerOrderCompleteReviewParam> reviews)?  completeParam,TResult? Function( String orderItemId,  int rating,  String? review, @JsonKey(includeFromJson: false, includeToJson: false)  List<File> images)?  completeReviewParam,TResult? Function( String orderId,  String reason,  String? customerBank,  String? customerAccountNumber,  String? customerAccountName)?  cancelParam,TResult? Function( String? id,  String? invoiceNumber,  String? invoiceUrl,  String? merchantId,  int? customerId,  String? customerAddressId,  String? merchantAccountId,  int? subtotal,  int? shippingCost,  int? serviceFee,  String? promotionId,  String? promotionCode,  String? promotionTitle,  String? promotionType,  int? promotionDiscount,  dynamic promotion,  List<dynamic>? promotions,  int? total,  int? paidAmount,  String? paymentProof,  String? type,  OrderStatus? status,  String? statusLabel,  String? notes,  String? cancelReason,  String? customerBank,  String? customerAccountNumber,  String? customerAccountName,  String? refundProof,  dynamic customer,  dynamic customerAddress,  dynamic merchantAccount,  dynamic merchant,  List<CustomerOrderItemEntity>? items,  List<dynamic>? reviews,  bool? needsReview,  CustomerShippingEntity? shipping,  String? paidAt,  String? cancelledAt,  String? completedAt,  String? createdAt,  String? updatedAt,  String? chatUrl, @JsonKey(name: 'next_actions')  List<CustomerOrderNextActionEntity>? nextActions)?  entity,}) {final _that = this;
switch (_that) {
case CustomerOrderCreateParam() when createParam != null:
return createParam(_that.addressId,_that.shippingKey,_that.biteshipRateKey,_that.merchantAccountId,_that.notes,_that.cartIds,_that.promotionId,_that.promotionCode);case CustomerOrderGetPromotionParam() when getPromotionParam != null:
return getPromotionParam(_that.cartIds,_that.addressId,_that.shippingKey,_that.biteshipRateKey);case CustomerOrderCompleteParam() when completeParam != null:
...
class CustomerOrderCreateParam implements CustomerOrder {
  const CustomerOrderCreateParam({required this.addressId, this.shippingKey, this.biteshipRateKey, this.merchantAccountId, this.notes, required final  List<String> cartIds, this.promotionId, this.promotionCode, final  String? $type}): _cartIds = cartIds,$type = $type ?? 'createParam';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CustomerOrderCreateParam&&(identical(other.addressId, addressId) || other.addressId == addressId)&&(identical(other.shippingKey, shippingKey) || other.shippingKey == shippingKey)&&(identical(other.biteshipRateKey, biteshipRateKey) || other.biteshipRateKey == biteshipRateKey)&&(identical(other.merchantAccountId, merchantAccountId) || other.merchantAccountId == merchantAccountId)&&(identical(other.notes, notes) || other.notes == notes)&&const DeepCollectionEquality().equals(other._cartIds, _cartIds)&&(identical(other.promotionId, promotionId) || other.promotionId == promotionId)&&(identical(other.promotionCode, promotionCode) || other.promotionCode == promotionCode));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,addressId,shippingKey,biteshipRateKey,merchantAccountId,notes,const DeepCollectionEquality().hash(_cartIds),promotionId,promotionCode);

@override
String toString() {
  return 'CustomerOrder.createParam(addressId: $addressId, shippingKey: $shippingKey, biteshipRateKey: $biteshipRateKey, merchantAccountId: $merchantAccountId, notes: $notes, cartIds: $cartIds, promotionId: $promotionId, promotionCode: $promotionCode)';
}
...
@useResult
$Res call({
 String addressId, String? shippingKey, String? biteshipRateKey, String? merchantAccountId, String? notes, List<String> cartIds, String? promotionId, String? promotionCode
});
...
/// Create a copy of CustomerOrder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? addressId = null,Object? shippingKey = freezed,Object? biteshipRateKey = freezed,Object? merchantAccountId = freezed,Object? notes = freezed,Object? cartIds = null,Object? promotionId = freezed,Object? promotionCode = freezed,}) {
...
class CustomerOrderEntity implements CustomerOrder {
 ...
 final  List<CustomerOrderNextActionEntity>? _nextActions;
@JsonKey(name: 'next_actions') List<CustomerOrderNextActionEntity>? get nextActions {
...
as String?,chatUrl: freezed == chatUrl ? _self.chatUrl : chatUrl // ignore: cast_nullable_to_non_nullable
as String?,nextActions: freezed == nextActions ? _self._nextActions : nextActions // ignore: cast_nullable_to_non_nullable
as List<CustomerOrderNextActionEntity>?,
  ));
}
