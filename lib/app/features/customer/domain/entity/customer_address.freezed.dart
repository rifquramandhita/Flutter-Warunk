        ...
        switch (json['runtimeType']) {
          ...
          return CustomerAddressEntity.fromJson(
            json
                ...
                case 'sendParam':
          return CustomerAddressSendParam.fromJson(
            json
          );
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,recipientName,phone,label,address,province,city,district,postalCode,longitude,latitude,notes,isDefault);

@override
String toString() {
  return 'CustomerAddress(id: $id, recipientName: $recipientName, phone: $phone, label: $label, address: $address, province: $province, city: $city, district: $district, postalCode: $postalCode, longitude: $longitude, latitude: $latitude, notes: $notes, isDefault: $isDefault)';
}
...
@useResult
$Res call({
 String id, String recipientName, String phone, String label, String address, String province, String city, String district, String postalCode, double longitude, double latitude, String? notes, bool isDefault
});
...
/// Create a copy of CustomerAddress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? recipientName = null,Object? phone = null,Object? label = null,Object? address = null,Object? province = null,Object? city = null,Object? district = null,Object? postalCode = null,Object? longitude = null,Object? latitude = null,Object? notes = freezed,Object? isDefault = null,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( CustomerAddressEntity value)?  entity,TResult Function( CustomerAddressSendParam value)?  sendParam,required TResult orElse(),}){
final _that = this;
switch (_that) {
case CustomerAddressEntity() when entity != null:
return entity(_that);case CustomerAddressSendParam() when sendParam != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( CustomerAddressEntity value)  entity,required TResult Function( CustomerAddressSendParam value)  sendParam,}){
final _that = this;
switch (_that) {
case CustomerAddressEntity():
return entity(_that);case CustomerAddressSendParam():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( CustomerAddressEntity value)?  entity,TResult? Function( CustomerAddressSendParam value)?  sendParam,}){
final _that = this;
switch (_that) {
case CustomerAddressEntity() when entity != null:
return entity(_that);case CustomerAddressSendParam() when sendParam != null:
...
return sendParam(_that.id,_that.recipientName,_that.phone,_that.label,_that.address,_that.province,_that.city,_that.district,_that.postalCode,_that.longitude,_that.latitude,_that.notes,_that.isDefault);case _:
  return orElse();
...
return sendParam(_that.id,_that.recipientName,_that.phone,_that.label,_that.address,_that.province,_that.city,_that.district,_that.postalCode,_that.longitude,_that.latitude,_that.notes,_that.isDefault);}
}
...
@JsonSerializable(fieldRename: FieldRename.snake, includeIfNull: false)
class CustomerAddressSendParam implements CustomerAddress {
  const CustomerAddressSendParam({@JsonKey(includeToJson: false, includeFromJson: false) this.id, required this.recipientName, required this.phone, required this.label, required this.address, required this.province, required this.city, required this.district, required this.postalCode, required this.longitude, required this.latitude, this.notes, required this.isDefault, final  String? $type}): $type = $type ?? 'sendParam';
  factory CustomerAddressSendParam.fromJson(Map<String, dynamic> json) => _$CustomerAddressSendParamFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$CustomerAddressSendParamCopyWith<CustomerAddressSendParam> get copyWith => _$CustomerAddressSendParamCopyWithImpl<CustomerAddressSendParam>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CustomerAddressSendParamToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CustomerAddressSendParam&&(identical(other.id, id) || other.id == id)&&(identical(other.recipientName, recipientName) || other.recipientName == recipientName)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.label, label) || other.label == label)&&(identical(other.address, address) || other.address == address)&&(identical(other.province, province) || other.province == province)&&(identical(other.city, city) || other.city == city)&&(identical(other.district, district) || other.district == district)&&(identical(other.postalCode, postalCode) || other.postalCode == postalCode)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.isDefault, isDefault) || other.isDefault == isDefault));
}
...
@override
String toString() {
  return 'CustomerAddress.sendParam(id: $id, recipientName: $recipientName, phone: $phone, label: $label, address: $address, province: $province, city: $city, district: $district, postalCode: $postalCode, longitude: $longitude, latitude: $latitude, notes: $notes, isDefault: $isDefault)';
}
...
/// @nodoc
abstract mixin class $CustomerAddressSendParamCopyWith<$Res> implements $CustomerAddressCopyWith<$Res> {
  factory $CustomerAddressSendParamCopyWith(CustomerAddressSendParam value, $Res Function(CustomerAddressSendParam) _then) = _$CustomerAddressSendParamCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(includeToJson: false, includeFromJson: false) String? id, String recipientName, String phone, String label, String address, String province, String city, String district, String postalCode, double longitude, double latitude, String? notes, bool isDefault
});
...
/// @nodoc
class _$CustomerAddressSendParamCopyWithImpl<$Res>
    implements $CustomerAddressSendParamCopyWith<$Res> {
  _$CustomerAddressSendParamCopyWithImpl(this._self, this._then);

  final CustomerAddressSendParam _self;
  final $Res Function(CustomerAddressSendParam) _then;

/// Create a copy of CustomerAddress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? recipientName = null,Object? phone = null,Object? label = null,Object? address = null,Object? province = null,Object? city = null,Object? district = null,Object? postalCode = null,Object? longitude = null,Object? latitude = null,Object? notes = freezed,Object? isDefault = null,}) {
  return _then(CustomerAddressSendParam(
